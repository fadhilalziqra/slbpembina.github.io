<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-6"><a href="<?php echo base_url() ?>admin/tambah" class="btn btn-info mb-2">Tambah
				Data</a></div>
		<div class="col-md-12">
			<table class="table">
				<thead>
                ...
                <?php $i = 1; ?>
                    ...
                    <tr>
                        ...
                        <td><?= $us['deskripsi']; ?></td>
						<td><?= $us['tanggal']; ?></td>
						<td><img src="<?= base_url('assets/img/berita/') . $us['gambar']; ?>"style="width: 100px;" class="img-thumbnail" alt=""></td>
                        <td>
