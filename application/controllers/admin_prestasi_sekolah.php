...
class admin_prestasi_sekolah extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('admin_prestasi_sekolah/vw_prestasi',$data);
        $this->load->view('layout_admin/footer');
    }

    public function tambah(){
        $data['judul'] = "Halaman Tambah Prestasi Sekolah";
        // $data['user']= $this->db->get_where('user',['email'=> $this->session->userdata('email')])->row_array();
        $data['berita'] = $this->prestasi_sekolah_model->get();
        ...
        $this->load->view("admin_prestasi_sekolah/vw_tambah_prestasi", $data);
        ...
        $upload_image = $_FILES['gambar']['name'];
            if ($upload_image) {
                ...
                $config['upload_path'] = './assets/img/prestasi_sekolah/';
    ...
    public function edit($id){
        $data['judul'] = "Halaman Edit Prestasi Sekolah";
        ...
        if ($this->form_validation->run() == false) {
       $this->load->view("layout_admin/header", $data);
        $this->load->view("admin_prestasi_sekolah/vw_edit_prestasi", $data);
        $this->load->view("layout_admin/footer",$data);
        } else {
        $data=[
            'judul'=> $this->input->post('judul'),
            ...
            if ($upload_image) {
                ...
                if ($this->upload->do_upload('gambar')) {
                    ...
                    if ($old_image != '1.jpg') {
                        unlink(FCPATH . 'assets/img/prestasi_sekolah/' . $old_image);
                    }
                    $new_image = $this->upload->data('file_name');
                    $this->db->set('gambar', $new_image);
                } else {
            ...
            $this->prestasi_sekolah_model->update(['id' => $id], $data, $upload_image);
